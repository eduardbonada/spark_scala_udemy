object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(125); 
  ...
  val isBest: Boolean = picard == bestCaptain;System.out.println("""isBest  : Boolean = """ + $show(isBest ));$skip(305); 
  ...
  val doubled_pi = pi * 2;System.out.println("""doubled_pi  : Double = """ + $show(doubled_pi ));$skip(44); 
  println(f"Doubled pi is $doubled_pi%.3f")}
