object LearningScala2 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(141); 
  ...
  val number = 2;System.out.println("""number  : Int = """ + $show(number ));$skip(146); 
  number match {
  	case 1 => println("One")
  	case 2 => println("Two")
  ...
  do { println(x); x+=1 } while (x <= 10);$skip(154); val res$0 = 
   ...
   {val x = 10; x + 20};System.out.println("""res0: Int = """ + $show(res$0));$skip(82); 
	 ...
	 var number_back_2 = 0;System.out.println("""number_back_2  : Int = """ + $show(number_back_2 ));$skip(24); 
	 var number_back_1 = 1;System.out.println("""number_back_1  : Int = """ + $show(number_back_1 ));$skip(151); 
	 for(i <- 1 to 10){
