object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  transformInt(2, x => {val y = x * 2; y * y});System.out.println("""res2: Int = """ + $show(res$2));$skip(429); 
  ...
  def transformToUpperCaseV1(s: String) : String = {
  	s.toUpperCase()
  };System.out.println("""transformToUpperCaseV1: (s: String)String""");$skip(37); val res$3 = 
  
  transformToUpperCaseV1("HeLlO");System.out.println("""res3: String = """ + $show(res$3));$skip(89); 
  
  def transformToUpperCaseV2(s: String, f: String => String) : String = {
  	f(s)
  };System.out.println("""transformToUpperCaseV2: (s: String, f: String => String)String""");$skip(61); val res$4 = 
  
  transformToUpperCaseV2("HeLlO", s => {s.toUpperCase()});System.out.println("""res4: String = """ + $show(res$4))}
