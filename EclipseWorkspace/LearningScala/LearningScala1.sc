object LearningScala1 {
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = HolaThere!
  println(immutableHelloThere)                    //> HolaThere!
  ...
  val doubled_pi = pi * 2                         //> doubled_pi  : Double = 6.2831853
  println(f"Doubled pi is $doubled_pi%.3f")       //> Doubled pi is 6.283
